    ...
    if (item.items) {
      return (
        <Collapsible key={item.title} className="group/collapsible">
          <CommandItem asChild>
            <CollapsibleTrigger className="flex w-full items-center justify-between gap-2 px-2 py-1.5 [&[data-state=open]>svg]:rotate-180">
  ...
  return (
    <>
      <Button
        ...
        size="lg"
        className={cn(
          'w-full max-w-64 justify-start rounded-md bg-muted/50 px-3 text-muted-foreground',
          buttonClassName
        )}
